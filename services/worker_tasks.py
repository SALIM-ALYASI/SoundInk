...
def generate_audio_task(self, text: str, voice_id: str = "voice1", bgm_id: str = None, mode: str = "normal") -> Dict[str, Any]:
    """
    ...
    try:
        ...
        result = pipeline.generate_dual_output(text, voice_id, bgm_id, mode)
