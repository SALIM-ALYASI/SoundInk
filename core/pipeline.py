...
class EchoPipeline:
    ...
    def generate_dual_output(self, text: str, voice_id: str = "voice1") -> Dict[str, Any]:
        """
        1. Creates a Session.
        2. Splits Text.
        3. Generates chunks.
        ...
        pauses = [0.2 for _ in chunk_paths]  # Small pause between sentences
        
        logger.info("Stitching chunks into Normal WAV...")
        self.renderer.concatenate_audio(chunk_paths, pauses, normal_wav, tmp_dir)
        ...
        logger.info("Mixing Cinematic Output with BGM & Ducking...")
        ...
        return {
            "session_id": session_id,
            "normal_url": f"/api/session/{session_id}/normal.mp3",
            "cinematic_url": f"/api/session/{session_id}/cinematic.mp3",
            "segments": parsed_segments
        }
    ...
    def heal_segment(self, session_id: str, segment_index: int, new_text: str) -> Dict[str, Any]:
        ...
        self.renderer.concatenate_audio(chunk_paths, meta["pauses"], normal_wav, tmp_dir)
        self.renderer.convert_to_mp3(normal_wav, normal_mp3)
